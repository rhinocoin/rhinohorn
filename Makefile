...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Mar 18 13:06:32 2014
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu /opt/rhinohorn/src/leveldb/libleveldb.a /opt/rhinohorn/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /opt/rhinohorn/src/leveldb/libleveldb.a; cd /opt/rhinohorn/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/opt/rhinohorn/src/leveldb/libleveldb.a: FORCE
	cd /opt/rhinohorn/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/opt/rhinohorn/build/build.h: FORCE
	cd /opt/rhinohorn; /bin/sh share/genbuild.sh /opt/rhinohorn/build/build.h
